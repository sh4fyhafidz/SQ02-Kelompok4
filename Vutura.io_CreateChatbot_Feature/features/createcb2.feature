...
Feature: Create Chatbot 02
    As a user
    I want to be able to create chatbot on Dshboard bot Vutura.io by Template
    ...
    Scenario: User success to create chatbot on the website
        ...
        And user click check box icon
        And user click select template
        And user click template
